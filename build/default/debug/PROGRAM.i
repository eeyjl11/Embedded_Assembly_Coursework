...
# 1 "C:/Program Files/Microchip/MPLABX/v6.10/packs/Microchip/PIC16Fxxx_DFP/1.4.149/xc8\\pic\\include\\xc.inc" 1 3
...
# 1 "C:/Program Files/Microchip/MPLABX/v6.10/packs/Microchip/PIC16Fxxx_DFP/1.4.149/xc8\\pic\\include\\pic.inc" 1 3



# 1 "C:/Program Files/Microchip/MPLABX/v6.10/packs/Microchip/PIC16Fxxx_DFP/1.4.149/xc8\\pic\\include\\pic_as_chip_select.inc" 1 3
# 723 "C:/Program Files/Microchip/MPLABX/v6.10/packs/Microchip/PIC16Fxxx_DFP/1.4.149/xc8\\pic\\include\\pic_as_chip_select.inc" 3
# 1 "C:/Program Files/Microchip/MPLABX/v6.10/packs/Microchip/PIC16Fxxx_DFP/1.4.149/xc8\\pic\\include\\proc\\pic16f887.inc" 1 3
# 47 "C:/Program Files/Microchip/MPLABX/v6.10/packs/Microchip/PIC16Fxxx_DFP/1.4.149/xc8\\pic\\include\\proc\\pic16f887.inc" 3
INDF equ 0000h
...
EECON2 equ 018Dh
# 2818 "C:/Program Files/Microchip/MPLABX/v6.10/packs/Microchip/PIC16Fxxx_DFP/1.4.149/xc8\\pic\\include\\proc\\pic16f887.inc" 3
...
# 724 "C:/Program Files/Microchip/MPLABX/v6.10/packs/Microchip/PIC16Fxxx_DFP/1.4.149/xc8\\pic\\include\\pic_as_chip_select.inc" 2 3
# 5 "C:/Program Files/Microchip/MPLABX/v6.10/packs/Microchip/PIC16Fxxx_DFP/1.4.149/xc8\\pic\\include\\pic.inc" 2 3
...
# 48 "./ECH_1.inc" 2
  ...
  ; for EQU statements related to the 44 pin demo board wiring of PORTD and ((PORTB) and 07Fh), 0
...
ReadADC: bsf ((ADCON0) and 07Fh), 1 ; start the conversion
RADC1: btfss ((ADCON0) and 07Fh), 1 ; test the DONE bit
...
SelBut: movwf S_Tmp ; W is used in DeBounce
  call DeBounce
  btfsc ((PORTB) and 07Fh), 0 ; skip the next instruction if the button is pressed
...
; rotate MSBs to LSBs
  bcf ((STATUS) and 07Fh), 0 ; clear carry flag as it is used for rotation
  rrf S_Tmp, F
  rrf S_Tmp, F
  rrf S_Tmp, F
  rrf S_Tmp, F
...
ISR:
 btfss ((INTCON) and 07Fh), 1
 goto I_L2
 call configModeSet
 bcf ((INTCON) and 07Fh), 1
I_L2: btfss ((INTCON) and 07Fh), 2
 goto I_L3
 call readADC
 call modeSet
...
; disable analogue inputs except for ((PORTA) and 07Fh), 0
  clrf ANSELH
  movlw 0b00000001
  movwf ANSEL
...
; init unused pins for PORTA (outputs)
  movlw 0b00000001 ; this constant was in W already, shown here for clarity
  movwf TRISA

; init PORTB (((PORTB) and 07Fh), 0 for input, unused pins for output)
  movlw 0b00000001 ; this constant was in W already, shown here for clarity
  movwf TRISB

; init PORTC (all pins unused - for output)
  movlw 0 ; this constant was in W already, shown here for clarity
  movwf TRISC

; init LEDs (PORTD to outputs)
  clrf TRISD

; init PORTE (four pins present, ((PORTE) and 07Fh), 3 is MCLR anyway; all outputs for simplicity)
  movlw 0b11111000
  movwf TRISE

; init the TMR0 keeping the two MSBs of OPTION_REG the same
  movf OPTION_REG,w
  andlw 0b00001000 ; prescaler to WDT to have Tcy clock for TMR0
       movwf OPTION_REG

; init the ADC - need bank 0 and 1
  clrf ADCON1 ; Left justified, refernces: Vss and Vdd
  banksel PORTD ; switch back to bank 0
  movlw 0b01000001 ; Fosc/8, AN0, enable
  movwf ADCON0
;}
